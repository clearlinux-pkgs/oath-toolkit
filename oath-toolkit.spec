...
Version  : 2.6.10
Release  : 8
URL      : https://download.savannah.nongnu.org/releases/oath-toolkit/oath-toolkit-2.6.10.tar.gz
Source0  : https://download.savannah.nongnu.org/releases/oath-toolkit/oath-toolkit-2.6.10.tar.gz
Source1  : https://download.savannah.nongnu.org/releases/oath-toolkit/oath-toolkit-2.6.10.tar.gz.sig
...
%prep
%setup -q -n oath-toolkit-2.6.10
cd %{_builddir}/oath-toolkit-2.6.10
pushd ..
cp -a oath-toolkit-2.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707089720
...
cp %{_builddir}/oath-toolkit-%{version}/COPYING %{buildroot}/usr/share/package-licenses/oath-toolkit/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
cp %{_builddir}/oath-toolkit-%{version}/liboath/COPYING %{buildroot}/usr/share/package-licenses/oath-toolkit/01a6b4bf79aca9b556822601186afab86e8c4fbf || :
cp %{_builddir}/oath-toolkit-%{version}/oathtool/COPYING %{buildroot}/usr/share/package-licenses/oath-toolkit/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
cp %{_builddir}/oath-toolkit-%{version}/pam_oath/COPYING %{buildroot}/usr/share/package-licenses/oath-toolkit/8624bcdae55baeef00cd11d5dfcfa60f68710a02 || :
pushd ../buildavx2/
%make_install_v3
popd
%make_install
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib/security/pam_oath.so
/V3/usr/lib64/liboath.so.0.1.3
/V3/usr/lib64/libpskc.so.0.0.1
